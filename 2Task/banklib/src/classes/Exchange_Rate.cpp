#include "banklib/classes/Exchange_Rate.h"
...
Currency_Type ExchangeRate::getSellingCurrency() const {
  return sellingCurrency_Type;
}

Currency_Type ExchangeRate::getBuyingCurrency() const {
  return buyingCurrency_Type;
}
