...
const uint64_t StaticStorage::openClientMoney[4][4] = {{10000, 4000, 25000, 15000},
                                                       {2000, 1000, 5000, 2000},
                                                       {100, 50, 200, 100},
                                                       {100, 50, 200, 100}};

const uint64_t maxClientAccountsAmount[4][4] = {{3, 5, 10, 25}, {1, 5, 5, 15}, {1, 3, 5, 10}, {1, 3, 5, 10}};
...
const uint64_t loanLimits[4][4] = {{3000000, 15000000, 50000000, 100000000},
